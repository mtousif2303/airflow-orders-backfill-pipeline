...
def main(date):
    ...
    input_path = f"gs://airflow-projects-de/airflow-project-02/data/orders_{date}.csv"
    ...
    output_path = f"gs://airflow-projects-de/airflow-project-02/output/processed_orders_{date}"
